...
def show_menu():
    menu_options = [
        ...
        ("3", "🕷️ Web Vulnerability Scanner", "Detect common vulnerabilities in web applications"),
        ("4", "🛡️ Security Header Audit", "Check HTTP security headers"),
    ...
    menu_content.append("Version 1.0.0 • © 2025 Sentra Security\n\n", style="italic #6C757D")
    ...
    # footer
    footer = Text("Select option 1-8 • Confirm: ENTER", style="italic #6C757D", justify="center")
